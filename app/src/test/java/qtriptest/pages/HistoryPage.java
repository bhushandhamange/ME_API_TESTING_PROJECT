...
public class HistoryPage {
    ...
    public HistoryPage(WebDriver driver2)
    {
        this.driver = driver2;    
    ...
    public List<ReservationHistory> getReservations()
    {
        ...
        for(WebElement row : tableRows)
        {
            ...
            ReservationHistory historyRecord = rs.CreateReservationHistory(tr_id, booking_name, adventure, person, date, price, bookingtime);
